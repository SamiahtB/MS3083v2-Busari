...
CREATE TABLE AutoNation_Dealership_Database.Features_Bridge(
    ...
    CONSTRAINT fk_wheels     FOREIGN KEY (WHEELS_ID)     REFERENCES AutoNation_Dealership_Database.Wheels(WHEEL_ID),
    CONSTRAINT fk_tires      FOREIGN KEY (TIRES_ID)      REFERENCES AutoNation_Dealership_Database.Tires(TIRES_ID),
