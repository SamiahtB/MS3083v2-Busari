...
-- ############################################################################
    ...
    COPY AutoNation_Dealership_Database.Tires (TIRE_ID, FRONT_ TIRE_SIZE, REAR_ TIRE_SIZE) FROM '/workspaces/MS3083v2-Busari/data/autonation/tires.csv' WITH (FORMAT csv, HEADER true);
    ...
    COPY AutoNation_Dealership_Database.Exterior (EXTERIOR_ID, CAR_LENGTH, CAR_WIDTH, WHEEL_BASE, CAR_ COLOR, BODY_STYLE, NUMBER_OF_DOORS, HEADLIGHT_TYPE) FROM '/workspaces/MS3083v2-Busari/data/autonation/exterior.csv' WITH (FORMAT csv, HEADER true);

    COPY AutoNation_Dealership_Database.Interior (INTERIOR_ID, KEYLESS_ENTRY, SEAT_MATERIAL, SEATING_CAPACITY, ENTERTAINMENT_SYSTEM, CRUISE_CONTROL, AUTOLOCK, STEERING_WHEEL_TYPE, BACK_CAMERA) FROM '/workspaces/MS3083v2-Busari/data/autonation/interior.csv' WITH (FORMAT csv, HEADER true);

    COPY AutoNation_Dealership_Database.Cargo (CARGO_AREA_ID, CARGO_VOLUME) FROM '/workspaces/MS3083v2-Busari/data/autonation/cargo.csv' WITH (FORMAT csv, HEADER true);
    ...
    COPY AutoNation_Dealership_Database.Salesperson (SALES_PERSON_ID, SALES_PERSON_FIRST_NAME, SALES_PERSON_LAST_NAME, EXPERIENCE_YEARS) FROM '/workspaces/MS3083v2-Busari/data/autonation/salesperson.csv' WITH (FORMAT csv, HEADER true);

    COPY AutoNation_Dealership_Database.Sales (SALES_ID, VEHICLE_ID, FINANCING_ID, PURCHASE_DATE, PAYMENT_FINANCED, PAYMENT_METHOD, SALES_PERSON_ID) FROM '/workspaces/MS3083v2-Busari/data/autonation/sales.csv' WITH (FORMAT csv, HEADER true);

    COPY AutoNation_Dealership_Database.Transactions (TRANSACTION_ID, SALES_ID, TRANSACTION_DATE, AMOUNT_PAID, PAYMENT_METHOD, DOWN_PAYMENT, PAID_IN_FULL) FROM '/workspaces/MS3083v2-Busari/data/autonation/transactions.csv' WITH (FORMAT csv, HEADER true);

    COPY AutoNation_Dealership_Database.Customers (CUSTOMER_ID, SALES_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, ADDRESS, CITY, STATE, ZIP_CODE) FROM '/workspaces/MS3083v2-Busari/data/autonation/customers.csv' WITH (FORMAT csv, HEADER true);
    ...
    COPY AutoNation_Dealership_Database.Warranty (WARRANTY_ID, SALES_ID , WARRANTY_TYPE, DURATION_MONTHS, MILEAGE,COST) FROM '/workspaces/MS3083v2-Busari/data/autonation/warranty.csv' WITH (FORMAT csv, HEADER true);

    COPY AutoNation_Dealership_Database.Features_Bridge (VEHICLE_ID, ENGINE_ID, FUEL_ID, WHEELS_ID, TIRES_ID, BRAKES_ID, STEERING_ID, SUSPENSION_ID, EXTERIOR_ID, INTERIOR_ID, CARGO_ID, WEIGHT_ID, EMISSIONS_ID, COST_ID) FROM '/workspaces/MS3083v2-Busari/data/autonation/features_bridge.csv' WITH (FORMAT csv, HEADER true);
